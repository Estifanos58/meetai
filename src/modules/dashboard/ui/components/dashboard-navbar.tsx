...
export const DashboardNavbar = () => {
    ...
    return (
      ...
      <nav className="flex px-4 gap-x-2 items-center py-3 border-b bg-background">
        ...
        <Button variant="outline" className="h-9 w-[240px] justify-start font-normal text-muted-forground hover:text-muted-foreground" size="sm" onClick={() => setCommandOpen((open) => !open)}>
            <SearchIcon/>
            Search
