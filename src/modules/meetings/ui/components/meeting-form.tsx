  ...
  const createMeeting = useMutation(
    trpc.meetings.create.mutationOptions({
      ...
      onError: (error) => {
        ...
        // TODO:  check if error message is forbiden
      },
    })
  );
   ...
   const updateMeeting = useMutation(
    trpc.meetings.updateMeeting.mutationOptions({
      ...
      onError: (error) => {
        toast.error(error.message || "Failed to update the meeting");
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                  ...
                  <button type="button"
                  onClick={()=> setOpenNewAgentDialog(true)} className="text-primary hover:underline">
                    Create new agent  
                  </button> 
              </FormDescription>
              <FormMessage />
